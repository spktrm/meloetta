...
from meloetta.frameworks.porygon.model.interfaces import Indices
...
class PorygonActor(Actor):
    ...
    def store_transition(self, state: State, env_step: EnvStep, room: BattleRoom):
        ...
        pid = room.get_pid()
        self._replay_buffer.store_sample(room.battle_tag, pid, to_store)
    ...
    def store_reward(
        ...
        if store_transition:
            ...
            self._replay_buffer.register_done(room.battle_tag, pid)

...
class PokemonEmbedding(nn.Module):
    ...
    def forward(
        ...
        active_move_embeddings = move_embeddings[:, :, 0, 0]
        return pokemon_emb, mask, active_move_embeddings
...
class SideEncoder(nn.Module):
    ...
    def forward(self, side: torch.Tensor) -> TensorDict:
        ...
        active_move_gates = self.move_gate(active_move_embeddings)

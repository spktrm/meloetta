...
from meloetta.frameworks.nash_ketchum.modelv2.config import EncoderConfig
from meloetta.frameworks.nash_ketchum.modelv2.encoders import (
    SideEncoder,
    ScalarEncoder,
    HistoryEncoder,
)
...
class Encoder(nn.Module):
    ...
    def forward(self, state: State) -> TensorDict:
        ...
        scalar_embeddings = self.scalar_encoder.forward(
            ...
            player_public_embedding=side_embeddings["player_public"],
            opponent_public_embedding=side_embeddings["opponent_public"],
        )

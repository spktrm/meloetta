    ...
    crushgrip: {
        ...
        basePowerCallback(pokemon, target) {
            ...
            const bp =
                Math.floor(
                    Math.floor(
                        (120 * (100 * Math.floor((hp * 4096) / maxHP)) +
                            2048 -
                            1) /
                            4096
                    ) / 100
        ...
        condition: {
            ...
            onResidual(target) {
                if (
                    ...
                    target.moveSlots[
                        target.moves.indexOf(this.effectState.move)
                    ].pp <= 0
                ) {
    ...
    flowershield: {
        ...
        onHitField(t, source, move) {
            ...
            for (const target of targets) {
                success =
                    this.boost({ def: 1 }, target, source, move) || success;
            }
            return success;
        },
        secondary: null,
    ...
    spikes: {
        ...
        condition: {
            ...
            onEntryHazard(pokemon) {
                ...
                this.damage(
                    (damageAmounts[this.effectState.layers] * pokemon.maxhp) /
                        24
                );
            },
        },
            ...
            onEntryHazard(pokemon) {
                ...
                const typeMod = this.clampIntRange(
                    pokemon.runEffectiveness(
                        this.dex.getActiveMove("stealthrock")
                    ),
                    -6,
                    6
                );
        ...
        condition: {
            ...
            onStart(target) {
                ...
                this.add(
                    "-start",
                    target,
                    "stockpile" + this.effectState.layers
                );

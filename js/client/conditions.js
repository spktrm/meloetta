"use strict";Object.defineProperty(exports, "__esModule", {value: true}); function _optionalChain(ops) { let lastAccessLHS = undefined; let value = ops[0]; let i = 1; while (i < ops.length) { const op = ops[i]; const fn = ops[i + 1]; i += 2; if ((op === 'optionalAccess' || op === 'optionalCall') && value == null) { return undefined; } if (op === 'access' || op === 'optionalAccess') { lastAccessLHS = value; value = fn(value); } else if (op === 'call' || op === 'optionalCall') { value = fn((...args) => value.call(lastAccessLHS, ...args)); lastAccessLHS = undefined; } } return value; } const Conditions = {
	...
	confusion: {
		...
		onStart(target, source, sourceEffect) {
			if (_optionalChain([sourceEffect, 'optionalAccess', _ => _.id]) === 'lockedmove') {
				this.add('-start', target, 'confusion', '[fatigue]');
			} else {
				this.add('-start', target, 'confusion');
			}
			const min = _optionalChain([sourceEffect, 'optionalAccess', _2 => _2.id]) === 'axekick' ? 3 : 2;
	...
	partiallytrapped: {
		...
		durationCallback(target, source) {
			if (_optionalChain([source, 'optionalAccess', _3 => _3.hasItem, 'call', _4 => _4('gripclaw')])) return 8;
		...
		onTrapPokemon(pokemon) {
			const gmaxEffect = ['gmaxcentiferno', 'gmaxsandblast'].includes(this.effectState.sourceEffect.id);
			if (_optionalChain([this, 'access', _5 => _5.effectState, 'access', _6 => _6.source, 'optionalAccess', _7 => _7.isActive]) || gmaxEffect) pokemon.tryTrap();
		},
	},
	lockedmove: {
	...
	snow: {
		...
		duration: 5,
		durationCallback(source, effect) {
			if (_optionalChain([source, 'optionalAccess', _20 => _20.hasItem, 'call', _21 => _21('icyrock')])) {
				return 8;
			}
			return 5;
		},
		...
		onFieldStart(field, source, effect) {
			if (_optionalChain([effect, 'optionalAccess', _22 => _22.effectType]) === 'Ability') {
				if (this.gen <= 5) this.effectState.duration = 0;

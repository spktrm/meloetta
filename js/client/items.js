"use strict";Object.defineProperty(exports, "__esModule", {value: true}); function _optionalChain(ops) { let lastAccessLHS = undefined; let value = ops[0]; let i = 1; while (i < ops.length) { const op = ops[i]; const fn = ops[i + 1]; i += 2; if ((op === 'optionalAccess' || op === 'optionalCall') && value == null) { return undefined; } if (op === 'access' || op === 'optionalAccess') { lastAccessLHS = value; value = fn(value); } else if (op === 'call' || op === 'optionalCall') { value = fn((...args) => value.call(lastAccessLHS, ...args)); lastAccessLHS = undefined; } } return value; } const Items = {
	abilityshield: {
		...
		onSetAbility(ability, target, source, effect) {
			if (effect && effect.effectType === 'Ability' && !_optionalChain([effect, 'access', _ => _.fullname, 'optionalAccess', _2 => _2.endsWith, 'call', _3 => _3('Trace')])) {
	...
	boosterenergy: {
		...
		onUpdate(pokemon) {
			...
			if (_optionalChain([this, 'access', _4 => _4.queue, 'access', _5 => _5.peek, 'call', _6 => _6(true), 'optionalAccess', _7 => _7.choice]) === 'runSwitch') return;
	...
	ejectpack: {
		...
		onAfterBoost(boost, target, source, effect) {
			if (_optionalChain([this, 'access', _8 => _8.activeMove, 'optionalAccess', _9 => _9.id]) === 'partingshot') return;
			let eject = false;
			let i;
			for (i in boost) {
				if (boost[i] < 0) {
	...
	mirrorherb: {
		...
		onFoeAfterBoost(boost, target, source, effect) {
			if (_optionalChain([effect, 'optionalAccess', _10 => _10.fullname, 'optionalAccess', _11 => _11.endsWith, 'call', _12 => _12('Opportunist')]) || _optionalChain([effect, 'optionalAccess', _13 => _13.fullname, 'optionalAccess', _14 => _14.endsWith, 'call', _15 => _15('Mirror Herb')])) return;
			const boostPlus = {};
	...
	vilevial: {
		...
		onTakeItem(item, pokemon, source) {
			if (_optionalChain([source, 'optionalAccess', _16 => _16.baseSpecies, 'access', _17 => _17.num]) === -66 || pokemon.baseSpecies.num === -66) {
				return false;
			}
			return true;
		},
